...
This folder contains a sample Blazor Web App, that has been modified to include all files required to deploy and run the application on Google Cloud Run.
...
The [Dockerfile](BlazorWebApp/Dockerfile) contains the steps required to build and publish the Blazor Web App.

Visual Studio can automatically add a Dockerfile while creating a new Blazor Web App project, or at a later stage by right-clicking on the project file and selecting *Add > Docker support*.
